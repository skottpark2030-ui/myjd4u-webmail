...
- 개인용으로 만든 단순 버전입니다. **받은편지함(최근 25통) 보기 · 읽기 · 보내기 · 답장 · 삭제(휴지통) · 복원 · 영구삭제**까지 됩니다.
- 아직 없는 것: 폴더 추가, 검색, 실시간 알림, 스레드. 필요하면 추가 가능.
- 삭제하면 메일은 Zoho의 휴지통(Trash) 폴더로 이동하고, 휴지통 탭에서 복원하거나 영구 삭제할 수 있습니다. 같은 메일함을 다른 기기/공식 Zoho 앱에서 봐도 동일하게 반영됩니다.
